...
class Target(object):
    ...
    def __init__(self,
        ...
        # Keep track of target files generated by this target. Note that one target rule
    ...
    def fingerprint(self):
        ...
        if self.__fingerprint is None:
            ...
            # Entropy dict can't contains normal object, because it's default repr contains address,
