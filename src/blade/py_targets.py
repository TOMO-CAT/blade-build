...
class PythonTarget(Target):
    ...
    def __init__(self, name, type, srcs, deps, base, visibility, tags, kwargs):
        """Init method."""
        ...
        if base:
            if not base.startswith("//"):
                self.error(
                    "Invalid base directory %s. Option base should be a directory "
...
class PythonLibrary(PythonTarget):
    ...
    def __init__(self, name, srcs, deps, base, visibility, tags, kwargs):
        """Init method."""
        super().__init__(
            name=name,
            type="py_library",
...
class PrebuiltPythonLibrary(PythonTarget):
    def __init__(self, name, srcs, deps, visibility, tags, base, kwargs):
        """Init method."""
        super().__init__(
            name=name,
...
class PythonBinary(PythonLibrary):
    ...
    def __init__(
        self, name, srcs, deps, visibility, tags, main, base, exclusions, kwargs
    ):
        """Init method."""
        srcs = var_to_list(srcs)
        deps = var_to_list(deps)
...
class PythonTest(PythonBinary):
    ...
    def __init__(
        self, name, srcs, deps, visibility, tags, main, base, testdata, kwargs
    ):
        """Init method."""
        super().__init__(
            name=name,
