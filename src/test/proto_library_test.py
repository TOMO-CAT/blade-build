...
class TestProtoLibrary(blade_test.TargetTest):
    ...
    def testGenerateRules(self):
        ...
        com_proto_cpp_option = self.findCommand(
            ["protobuf/bin/protoc", "cpp_out", "rpc_option.proto"]
        )
        com_proto_cpp_meta = self.findCommand(
            ["protobuf/bin/protoc", "cpp_out", "rpc_meta_info.proto"]
        )
